 ...
 */
class Zfb_Auth_Adapter_Doctrine implements Zend_Auth_Adapter_Interface{
    ...
    protected function _authenticateSetup()
    {
        ...
        if ($this->_tableName == '') {
            $exception = 'A table must be supplied for the Zfb_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_identityColumn == '') {
            $exception = 'An identity column must be supplied for the Zfb_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_credentialColumn == '') {
            $exception = 'A credential column must be supplied for the Zfb_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_identity == '') {
            $exception = 'A value for the identity was not provided prior to authentication with Zfb_Auth_Adapter_Doctrine.';
        } elseif ($this->_credential === null) {
            $exception = 'A credential value was not provided prior to authentication with Zfb_Auth_Adapter_Doctrine.';
        }
        ...
        if (null !== $exception) {
             ...
             */
            require_once 'Zfb/Auth/Adapter/Exception.php';
            throw new Zfb_Auth_Adapter_Exception($exception);
        }
    ...
    protected function _authenticateQuerySelect(Doctrine_Query $dbSelect)
    {
        try {
             ...
             */
            require_once 'Zfb/Auth/Adapter/Exception.php';
            throw new Zfb_Auth_Adapter_Exception('The supplied parameters to Zend_Auth_Adapter_DbTable failed to '
